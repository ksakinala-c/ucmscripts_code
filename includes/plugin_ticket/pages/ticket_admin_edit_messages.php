		                            ...
		                            switch(strtolower($matches[1])){
			                            ...
			                            case 'png':
				                            if(module_config::c('ticket_show_attachment_image_preview',1)) {
					                            ...
					                            ?>
					                            <div class="file_preview" style="float:right; width:<?php echo $thumb_width+10;?>px; margin:3px; border:1px solid #CCC; text-align:center;">
						                            <div style="width:<?php echo $thumb_width + 10;?>px; min-height:40px; ">
							                            <a href="<?php echo module_ticket::link_open_attachment($ticket_id,$attachment['ticket_message_attachment_id']); ?>" class="file_image_preview"
				        ...
				        <tr>
					        ...
					        <td align="left">
						        ...
						        if(module_security::get_loggedin_id() != $ticket['assigned_user_id']){
							        ?>
						            <span>
							            <a href="#" id="change_to_me" data-user-id="<?php echo module_security::get_loggedin_id();?>"><?php _e('Change to Me');?></a>
						            </span>
						            <?php
						        }
						        ?>
