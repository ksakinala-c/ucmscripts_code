...
<form action="" method="post" id="ticket_form" enctype="multipart/form-data">
    ...
    if(module_ticket::can_edit_tickets()){
	    ...
	    $fieldset_data['elements'][] = array(
		    'title' => _l('Customer'),
		    'fields' => array(
			    function() use ($ticket_id, $ticket, $done_in_ticket_billing){
		    ...
		    $fieldset_data['elements'][] = array(
			    ...
			    'fields' => array(
				    function () use ( $ticket_id ) {
					    ?> <a href="<?php echo module_ticket::link_public($ticket_id);?>" target="_blank"><?php _e('click here');?></a> <?php
				    }
			    )
		    );
	    }
