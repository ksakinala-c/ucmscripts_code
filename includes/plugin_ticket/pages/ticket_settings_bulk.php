...
if(isset($_POST['bulk_remove_priority']) && $_POST['bulk_remove_priority'] == 'go'){
    ...
    foreach($invoices as $invoice){
        ...
        if($invoice_check['invoice_id'] != $invoice['invoice_id'])continue;
        ...
        <input type="hidden" name="bulk" value="go">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="2" class="tableclass tableclass_form">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" name="send_message" value="1"> <?php _e('Yes, send below message to each ticket in group:');?>
                                <div>
...
<p>Thanks for your patience,<br /> dtbaker</p>");?></pre>
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                <input type="submit" name="butt_save" id="butt_save" value="<?php echo _l('Perform Bulk Actions'); ?>" class="submit_button save_button" />
            ...
            <table cellpadding="10" width="100%" class="tableclass tableclass_form">
                <tr>
                    <td valign="top" align="center">
                        <input type="submit" name="buttremove" id="buttremove" value="<?php echo _l('Remove Unpaid Support Invoices'); ?>" class="submit_button save_button" />
                    </td>
                </tr>
            </table>
        </form>
