...
<?php }
           ...
           /* if(module_config::c('job_task_percentage',1) && ($percentage==1 || $task_data['hours']>0)){
            ...
            if(isset($task_data['long_description']) && $task_data['long_description'] != ''){ ?>
                ...
                <div class="task_long_description" <?php if(module_config::c('job_tasks_show_long_desc',0)){ ?> style="display:block;" <?php } ?>><?php echo module_security::purify_html(forum_text(trim($task_data['long_description']), false));?></div>
            <?php }else{ ?>
                &nbsp;
            <?php }
