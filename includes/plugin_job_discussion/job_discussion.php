...
','New Comment on your Job: {JOB_NAME}',array(
    ...
    public static function hook_job_task_after($hook,$job_id,$task_id,$job_data,$task_data){
        ...
        ?>
        <a href="<?php echo self::link_public($job_id,$task_id);?>" id="discuss<?php echo $task_id;?>" class="task_job_discussion <?php echo $label ? 'with_text': '';?>" title="<?php _e('View Discussion');?>"><span><?php echo count($comments) > 0 ? count($comments) : '';?></span><?php echo $label;?></a>
