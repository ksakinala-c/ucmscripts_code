			...
			<form action="" method="post" id="twitter_edit_form">
				<div id="twitter_message_header">
					<div style="float:right; text-align: right; margin-top:-4px;">
						<small><?php echo print_date( $twitter_message->get('message_time'), true ); ?> </small><br/>
...
if($social_twitter_id && !$social_twitter_message_id && module_social::can_i('create','Twitter Comments','Social','social')){
    ...
    if($social_twitter_id && $twitter->get('social_twitter_id') == $social_twitter_id){
	    ...
	    <form action="<?php echo module_social_twitter::link_open_message_view($social_twitter_id);?>" method="post" enctype="multipart/form-data">
...
<script type="text/javascript" src="<?php echo _BASE_HREF;?>includes/plugin_social_twitter/js/jquery.charactercounter.js"></script>
