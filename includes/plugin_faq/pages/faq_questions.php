		        ...
		        function() use($faq){
	                ...
	                foreach(module_faq::get_faq_products_rel() as $faq_product_id => $product_name){
		                ...
		                <div>
		                    ...
		                    <label for="multi_<?php echo $faq_product_id;?>"><?php echo htmlspecialchars($product_name);?> (<?php echo ($faq_product['default_type_id']) ? $default_types[$faq_product['default_type_id']]['name'] : _l('N/A');?>)</label>
