 ...
 * @subpackage AuthorizeNetAIM
 */
define('AUTHORIZE_LIVE_URL',module_config::c('payment_method_authorize_live_url','https://secure.authorize.net/gateway/transact.dll'));
define('AUTHORIZE_SANDBOX_URL',module_config::c('payment_method_authorize_sandbox_url','https://test.authorize.net/gateway/transact.dll'));
...
class AuthorizeNetAIM extends AuthorizeNetRequest
{
    ...
    {
        return ($this->_sandbox ? AUTHORIZE_SANDBOX_URL : AUTHORIZE_LIVE_URL);
    }
