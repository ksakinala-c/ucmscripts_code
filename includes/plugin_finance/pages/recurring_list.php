        ...
        <tr class="<?php echo ($c++%2)?"odd":"even"; ?>">
            ...
            <td>
                <?php if($recurring['type']=='i'){
                    ...
                    $balance+=$recurring['amount']; ?><span class="success_text">+<?php echo dollar($recurring['amount'],true,$recurring['currency_id']); ?></span><?php } ?>
            </td>
            <td>
                <?php if($recurring['type']=='e'){
                    // todo - calculate balance during the data gathering stage incase a search is performed that returns a subset of available transactions
                    $balance-=$recurring['amount']; ?><span class="error_text">-<?php echo dollar($recurring['amount'],true,$recurring['currency_id']); ?></span><?php } ?>
            </td>
            <td>
                <?php
