...
if(!is_dir('includes/plugin_pdf/mpdf/') || !is_file('includes/plugin_pdf/mpdf/mpdf.php')){
	...
	<ul>
		<li><a href="<?php echo htmlspecialchars($_SERVER["REQUEST_URI"]) . (strpos($_SERVER["REQUEST_URI"],'?') ? '&' : '?') .'auto_pdf_install';?>">Click here to attempt an automatic installation</a> (recommended)</li>
	</ul>
	Manual Install:
	<ul>
