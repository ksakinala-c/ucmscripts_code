...
$this->backupSubsFont = array('arial');
...
$this->sans_fonts = array('dejavusanscondensed','dejavusans','freesans','liberationsans','sans','sans-serif','cursive','fantasy',
				...
				'trebuchetms','lucidasansunicode','franklingothicmedium','albertusmedium','albasuper','quillscript' //'xbriyaz',
...
$this->serif_fonts = array('dejavuserifcondensed','dejavuserif','freeserif','liberationserif','serif',
				...
				'norasi','charis','palatino','constantia','georgia','albertus','algerian','garamond', //'xbzar',
);
