	...
	<?php if($data_record_id && $data_record_id != 'new') { ?>
		<div class="ui-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-collapsible">
			<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
				...
				<?php } ?>
				<li class="ui-state-default ui-corner-top <?php echo ( $mode == 'view' ) ? 'link_current ui-tabs-active ui-state-active' : ''; ?>">
					<a href="<?php echo $module->link( '', array(
				...
				<?php if ( $module->can_i( 'edit', $data_type['data_type_name'] ) ) { ?>
					<li class="ui-state-default ui-corner-top <?php echo ( $mode == 'edit' ) ? 'link_current ui-tabs-active ui-state-active' : ''; ?>">
						<a href="<?php echo $module->link( '', array(
							'data_type_id'   => $data_type_id,
							'data_record_id' => $data_record_id,
							'mode'           => 'edit',
				...
				<?php } ?>
				<li class="ui-state-default ui-corner-top <?php echo ( $mode == 'revisions' ) ? 'link_current ui-tabs-active ui-state-active' : ''; ?>">
					<a href="<?php echo $module->link( '', array(
						'data_type_id'   => $data_type_id,
						'data_record_id' => $data_record_id,
						'mode'           => 'revisions',
				...
				<li class="ui-state-default ui-corner-top">
					<a href="<?php echo $_SERVER['REQUEST_URI'] . '&print=true'; ?>"
					   onclick="window.open(this.href,'pop','width=900,height=700,scrollbars=1'); return false;" class="ui-tabs-anchor"><?= _l( 'Print' ); ?></a>
				</li>
				...
				<?php if ( $module->can_i( 'edit', _MODULE_DATA_NAME ) ) { ?>
					<li class="ui-state-default ui-corner-top <?php echo ( $mode == 'admin' ) ? 'link_current ui-tabs-active ui-state-active' : ''; ?>">
						<a href="<?php echo module_data::link_open_data_type( $data_type_id ); ?>" class="ui-tabs-anchor"><?= _l( 'Settings' ); ?></a>
					</li>
				<?php } ?>
			</ul>
		</div>
		...
		switch($mode){
			case 'email':
				...
				Available Template Keys:	</p>
					<ul>
					<?php foreach($replace as $key=>$val){ if(strpos($val,'encrypt_popup'))continue; ?>
			...
			case 'pdf':
				...
				if(!function_exists('convert_html2pdf'))die('PDF generation not available');
