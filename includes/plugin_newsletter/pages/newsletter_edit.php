...
<table width="100%" cellpadding="5">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="2" class="tableclass tableclass_form">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="subject" id="subject" style="width:250px;" value="<?php echo htmlspecialchars($newsletter['subject']); ?>" />
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" name="from_name" id="from_name" style="width:250px;" value="<?php echo htmlspecialchars($newsletter['from_name']); ?>" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="from_email" id="from_email" style="width:250px;" value="<?php echo htmlspecialchars($newsletter['from_email']); ?>" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="bounce_email" id="bounce_email" style="width:250px;" value="<?php echo htmlspecialchars($newsletter['bounce_email']); ?>" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="to_name" style="width:250px;" value="<?php echo htmlspecialchars($newsletter['to_name']); ?>" />
                ...
                <tbody>
                    ...
                    <tr>
                        <td align="center" style="text-align: center">
                            ...
                            <input type="hidden" name="newsletter_template_id" id="newsletter_template_id" value="<?php echo $newsletter['newsletter_template_id'];?>">

                            <?php
                            foreach($templates as $template){
                                $template = module_newsletter::get_newsletter_template($template['newsletter_template_id']);
                                ?>
                                <div class="template<?php echo ($newsletter['newsletter_template_id']==$template['newsletter_template_id'])?' selected':'';?>" onclick="$('#newsletter_template_id').val(<?php echo $template['newsletter_template_id'];?>); $('.template').removeClass('selected'); $(this).addClass('selected'); $('#butt_save').click(); " style="cursor: pointer;">
                ...
                <tr>
                    <td style="text-align: center">
                        <p style="line-height: 24px;">
                            <input type="text" name="quick_email" value="<?php echo htmlspecialchars($newsletter['from_email']);?>" size="35"> <br/>
                            <input type="submit" name="butt_preview_email"  value="<?php echo _l('Email Preview'); ?>" class="valid_exit small_button">
                            <br/>
                            <input type="submit" name="butt_preview" value="<?php echo _l('Browser Preview'); ?>" class="valid_exit small_button" />
                        </p>
                    </td>
                </tr>
                </tbody>
                        ...
                        <tr>
                            <td valign="top">
                                ...
                                if($newsletter_template['directory'] && is_dir($newsletter_template['directory']) && is_file($newsletter_template['directory'].'wizard_ui.php')){
                                        ...
                                        if($current_newsletter_content_id && isset($newsletter['extra_content'][$current_newsletter_content_id])){
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="2" class="tableclass tableclass_form">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="subject2" style="width:250px;" value="<?php echo htmlspecialchars($newsletter['extra_content'][$current_newsletter_content_id]['group_title']); ?>" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="width2">
                                    ...
                                    ?>
                                    <textarea name="content" id="newsletter_editor_content"><?php echo htmlspecialchars($content);?></textarea>
                                    <?php if(trim($default_content)){ ?>
                                    <p><a href="#" onclick="set_default();return false;">click here</a> to load default content from template.</p>
                                    <?php } ?>
                                <?php } ?>
                            </td>
                            <td valign="top" width="360">
                                ...
                                <?php
                                    ...
                                    ?>
                                    <ul>
                                        <li><a href="#" onclick="return newsletter.edit_content(0);"><?php _e('Main Content');?><?php if(!$current_newsletter_content_id){ echo ' <strong>'._l('(Current)').'</strong>'; };?></a> </li>
                                        <?php foreach($newsletter['extra_content'] as $extra_newsletter_content_id => $extra_newsletter_content_data){ ?>
                                            <li><a href="#" onclick="return newsletter.edit_content(<?php echo $extra_newsletter_content_id;?>);"><?php _e('Main Content');?><?php if($current_newsletter_content_id == $extra_newsletter_content_id){ echo ' <strong>'._l('(Current)').'</strong>'; };?></a> </li>
                                        <?php } ?>
                                    </ul>
                                <?php } ?>
                            ...
                            <?php } ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#" onmousedown="tinyMCE.execCommand('mceInsertContent',false,'{<?php echo $key;?>}'); return false;" onclick="return false;"><?php echo '{'.htmlspecialchars($key).'}';?></a>
                                        </td>
                                        <td>
    ...
    <div align="center">
            ...
            <input type="submit" name="butt_send" id="butt_send" value="<?php echo _l('Send Newsletter'); ?>" class="submit_button" />
            <?php if(module_newsletter::can_i('create','Newsletters')){ ?>
            <input type="submit" name="butt_duplicate" id="butt_duplicate" value="<?php echo _l('Duplicate'); ?>" class="submit_button" />
            <?php } ?>
            <input type="button" name="cancel" value="<?php echo _l('Cancel'); ?>"
                   onclick="window.location.href='<?php echo module_newsletter::link_list(false); ?>';" class="submit_button" />
