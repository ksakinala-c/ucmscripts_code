                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" name="newsletter_template_name" value="<?php echo htmlspecialchars($newsletter_template['newsletter_template_name']); ?>" />
                            <?php echo htmlspecialchars($newsletter_template['newsletter_template_name']); ?>
                            <?php }else{ ?>
                             <input type="text" name="newsletter_template_name" value="<?php echo htmlspecialchars($newsletter_template['newsletter_template_name']); ?>" />
                            <?php } ?>
                        </td>
                    </tr>
                    <?php if(false){ ?>
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="wizard" value="0"<?php echo !$newsletter_template['wizard'] ? ' checked':'';?>> <?php _e('Single Body Area');?>
                            <input type="radio" name="wizard" value="1"<?php echo $newsletter_template['wizard'] ? ' checked':'';?>> <?php _e('Multiple Body Areas');?>
                        </td>
                    </tr>
                    <?php } ?>
    ...
    <tr>
        <td valign="top" width="70%">
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <textarea rows="20" cols="20" name="body" id="template_body" style="width:96%; height:500px; margin:5px;"><?php echo htmlspecialchars($newsletter_template['body']);?></textarea>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="2" class="tableclass tableclass_form">
                <tbody>
                    <tr>
                        <td>
                            <textarea rows="20" cols="20" name="default_inner" id="default_inner" style="width:96%; height:300px; margin:5px;"><?php echo htmlspecialchars(isset($newsletter_template['default_inner']) ? $newsletter_template['default_inner'] : '');?></textarea>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <td valign="top">
            ...
            <tbody>
                <tr>
                    <td class="width1">
                        <a href="#" onmousedown="$('#template_body').val($('#template_body').val() + '{BODY}'); return false;" onclick="return false;">{BODY}</a>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <a href="#" onmousedown="$('#template_body').val($('#template_body').val() + '<?php echo '<?php ?>';?>'); return false;" onclick="return false;">&lt;?php  ?&gt;</a>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <a href="#" onmousedown="$('#template_body').val($('#template_body').val() + '{<?php echo $key;?>}'); return false;" onclick="return false;"><?php echo '{'.htmlspecialchars($key).'}';?></a>
                    </td>
                    <td>
