...
// render the newsletter and display it on screen with nothing else.
    ...
    if(preg_match_all('#<a href=["\'].*ext\.php\?t=lnk&id=(\d+)&#',$content,$matches)){
        ...
        foreach($matches[0] as $key => $val){
            ...
            if(isset($processed_links[$link_match_id]))continue;
...
<iframe src="<?php echo module_newsletter::link_statistics_link_clicks($newsletter_id,$send_id);?>&show=true" frameborder="0" style="width:100%; height:700px; border:0;" background="transparent"></iframe>
