    ...
    <table width="100%" class="tableclass tableclass_full">
                ...
                <table class="tableclass tableclass_form tableclass_full">
                    ...
                    <tr>
                        ...
                        foreach($groups as $group){
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" name="group[<?php echo $group['group_id'];?>]" id="group_<?php echo $group['group_id'];?>" value="yes">
                                </td>
                                <td>
                                    <label for="group_<?php echo $group['group_id'];?>"><?php echo htmlspecialchars($group['name']);?></label>
                                </td>
                                <td>
        ...
        <tr>
            <td colspan="2" align="center">
                <input type="button" name="cancel" value="<?php _e('Cancel');?>" class="submit_button" onclick="window.location.href='<?php echo module_newsletter::link_open($newsletter_id);?>';">
