...
?>
<p><?php _e('Here is a link to the newsletter subscription form. When people fill this out they will appear in the "Members" area:');?> <a href="<?php echo module_member::link_public_subscribe();?>" target="_blank"><?php echo module_member::link_public_subscribe();?></a> <?php _e('(this form can be edited from Settings > Templates)'); ?></p>
    <?php
print_heading('Un-Subscription Form');

?>
<p><?php _e('Here is a link to the newsletter un-subscription form. People can click this and enter their email to be manually removed from receiving emails:');?> <a href="<?php echo module_newsletter::unsubscribe_url();?>" target="_blank"><?php echo module_newsletter::unsubscribe_url();?></a> <?php _e('(this form can be edited from Settings > Templates)'); ?></p>
<?php
