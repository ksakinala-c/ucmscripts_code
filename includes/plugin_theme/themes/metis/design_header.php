	                ...
	                ?>
                     <div class="btn-group">
	                     <?php if(!empty($header_button['dropdown'])){ ?>
	                        <a id="<?php echo $header_button['id'];?>" data-placement="bottom" data-original-title="<?php echo $header_button['title'];?>" href="#" data-toggle="dropdown" class="btn btn-default btn-sm dropdown-toggle">
								                     ...
								                     <?php if(!empty($dropdown_item['percentage'])){ ?>
									                     <div class="progress xs">
										                     <div class="progress-bar progress-bar-aqua"
										                          ...
										                          aria-valuemin="0"
										                          aria-valuemax="100">
											                     <span class="sr-only"><?php _e( '%s%% Complete', round( $dropdown_item['percentage'] * 100 ) ); ?></span>
										                     </div>
									                     </div>
								                     <?php } ?>
							                     </a>
	                     ...
	                     <?php }else{ ?>
		                <a id="<?php echo $header_button['id'];?>" data-placement="bottom" data-original-title="<?php echo $header_button['title'];?>" href="#" data-toggle="tooltip" class="btn btn-default btn-sm">
			                <i class="fa fa-<?php echo $header_button['fa-icon'];?>"></i>
		                </a>
	                     <?php } ?>
		            </div>
