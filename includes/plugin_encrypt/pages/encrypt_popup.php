...
if(!$encrypt_field_id && module_encrypt::can_i('create','Encrypts')){
    ...
    if(!$encrypt_field_name||!$page_name)die('Unable to encrypt this field. Sorry');
...
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/json2.js');?>?ver=<?php echo _SCRIPT_VERSION;?>"></script>
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/jsbn.js');?>?ver=<?php echo _SCRIPT_VERSION;?>"></script>
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/jsbn2.js');?>?ver=<?php echo _SCRIPT_VERSION;?>"></script>
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/prng4.js');?>?ver=<?php echo _SCRIPT_VERSION;?>"></script>
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/rng.js');?>?ver=<?php echo _SCRIPT_VERSION;?>"></script>
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/rsa.js');?>?ver=<?php echo _SCRIPT_VERSION;?>"></script>
<script language="JavaScript" type="text/javascript" src="<?php echo full_link('includes/plugin_encrypt/js/rsa2.js');?>?ver=<?php echo _SCRIPT_VERSION;?>"></script>
...
<table class="tableclass tableclass_form tableclass_full" id="enc_existing">
    ...
    <tr>
        ...
        <td id="env_vault_name">
            ...
            if($encryption_key && $encrypt && $encrypt['encrypt_key_id']){
                ...
                ?>
                <a href="#" onclick="$('#enc_existing').hide(); $('#enc_create_new').show();$('#encrypt_key_name')[0].focus(); return false;"><?php _e('Create New Vault');?></a>
                <?php
            }
            ?>
        </td>
    ...
    <tr>
        ...
        <td>
            <input type="password" name="encryptpass" id="encryptpass" value="" onchange="do_crypt(this.value);" onkeyup="do_crypt(this.value);">
            <script type="text/javascript">
                $(function(){
                    $('#encryptpass')[0].focus();
    ...
    <tr>
        ...
        <td>
            <textarea name="decrypted_value" <?php if(!module_encrypt::can_i('edit','Encrypts'))echo 'disabled="disabled" ';?> rows="7" cols="60" id="decrypted_value"><?php echo htmlspecialchars($existing_value);?></textarea>
        </td>
    </tr>
    <!-- <tr>
        <th >
    ...
    <tr>
        ...
        <td>
            <input type="submit" name="save" value="<?php _e('Encrypt and Save');?>" onclick="do_save();" class="submit_button save_button">
            <?php if($encrypt_id>0){ ?>
            <input type="submit" name="decrypt" value="<?php _e('Save Decrypted');?>" onclick="do_save_decrypted();" class="submit_button delete_button">
            <?php } ?>
        </td>
    </tr>
    <?php } ?>
    ...
    <table class="tableclass tableclass_form tableclass_full" id="enc_create_new" style="display:none;">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="button" name="save" value="<?php _e('Create New');?>" onclick="create_new();" class="submit_button save_button">
            </td>
        </tr>
        </tbody>
    </table>
