...
class module_paymethod_google extends module_base{
	...
	function init(){
        ...
        // 2.23 - 2016-07-10 - big update to mysqli
                      ...
                      // an order has been placed.
                        ...
                        if($google_order_number && $response->{'shopping-cart'}->{'merchant-private-data'}){
                            ...
                            if($invoice_id>0&&$invoice_payment_id>0){
                                ...
                                $sql="UPDATE `"._DB_PREFIX."invoice_payment` SET `other_id` = '".db_escape($google_order_number)."' WHERE invoice_id = '$invoice_id' AND invoice_payment_id = '$invoice_payment_id'";
                                query($sql);
                            }
                        }
