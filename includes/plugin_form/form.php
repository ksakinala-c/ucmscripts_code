...
class module_form extends module_base{
    ...
    public static function generate_form_element($setting){
        ...
        for($x=0; $x<$loop_count; $x++){
            ...
            if(isset($setting['multiple']) && $setting['multiple']){
                echo '<span class="form_multiple_actions"><a href="#" class="add_addit">+</a> <a href="#" class="remove_addit">-</a></span>';
                echo '</div>';
            }
        }
	...
	public static function hook_header_print_js(){
		if(module_security::is_logged_in()) {
			...
			ucm.settings.time_format = '<?php echo addcslashes(_l(preg_replace('#[^a-zA-Z:]#','',module_config::c('time_format','g:ia'))),"'");?>';
